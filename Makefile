...
bin/castle.exe: tree.fs tower.fs castle.fs main.fs
	fsharpc tree.fs tower.fs castle.fs main.fs -o bin/castle.exe -r bin/proj.dll -r packages/OpenTK/lib/net20/OpenTK.dll

bin/OpenTK.dll: packages
	cp packages/OpenTK/lib/net20/OpenTK.dll bin

bin/proj.dll: opengl.fs base.fs packages
	fsharpc base.fs opengl.fs -a -o bin/proj.dll -r packages/OpenTK/lib/net20/OpenTK.dll --nowarn:9
